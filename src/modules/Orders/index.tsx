      ...
      {orders.length > 0 && (
        <div className='text-center w-1/2 flex justify-center flex-col mt-16'>
          ...
          <table className="table-fixed">
            ...
            <tbody>
            {orders.map(order => (
              <tr className='border-b-2 h-12 cursor-pointer' key={order._id}>
                ...
                <td className='w-48 font-bold'>{order.minPrice} {order.isEthToToken == 1 ? 'ETH' : order.tokenSymbol}/{order.isEthToToken == 1 ? order.tokenSymbol : 'ETH'} </td>
              </tr>
            ))}
            </tbody>
          </table>
